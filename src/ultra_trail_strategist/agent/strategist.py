...
class RaceState(TypedDict):
    ...
    race_date: Optional[str]  # YYYY-MM-DD
...
class StrategistAgent:
    ...
    def __init__(self):
        ...
        self.llm = ChatOpenAI(model="gpt-4o", temperature=0.7, api_key=SecretStr(api_key))
    ...
    async def run_nutritionist(self, state: RaceState) -> Dict[str, Any]:
        ...
        try:
            report = await self.nutritionist.generate_nutrition_plan(
                segments, start_lat, start_lon, race_date=race_date
            )
