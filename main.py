...
async def main():
    ...
    print("🧠 Thinking... (Querying Strava, Weather & Simulating Race)")
    try:
        result = await agent.workflow.ainvoke(initial_state)

        print("\n" + "=" * 50)
        print("🏃‍♂️ PACING REPORT (Generated by ML) 🏃‍♂️")
        print("=" * 50)
        print(result.get("pacing_report", "No report."))

        print("\n" + "=" * 50)
        print("🥗 NUTRITION REPORT (Weather-Adaptive) 🥗")
        print("=" * 50)
        print(result.get("nutrition_report", "No report."))

        print("\n" + "=" * 50)
        print("🏁 FINAL COACH STRATEGY 🏁")
        print("=" * 50)
